...
interface Props {
    station?: Station;
    onClose: () => void;
    onSubmitReport?: (payload: CrowdReportPayload) => void | Promise<void>;
}
...
export default function ReportModal({
    ...
    const platformOptions: { id: 'platform_1' | 'platform_2' | 'both'; label: string }[] = [
        {
            id: 'platform_1',
            label: station?.platform_1_direction?.replace('Towards ', '') ?? 'Platform A',
        },
        {
            id: 'platform_2',
            label: station?.platform_2_direction?.replace('Towards ', '') ?? 'Platform B',
        },
                ...
                <div className="px-5 py-5 flex flex-col gap-5">
                    {submitted ? (
                        ...
                        <>
                            ...
                            >
                                {submitting ? 'Sending…' : 'Submit Rush Update'}
                            </button>
                        </>
                    )}
                </div>
